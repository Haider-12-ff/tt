...
const App: React.FC = () => {
  ...
  // Trigger app transition once components are mounted
  useEffect(() => {
    setIsAppReady(true);
  }, []);
        ...
        <div className="max-w-4xl w-full z-10 space-y-16 stagger-in">
          <div className="text-center space-y-8">
            ...
            <p className="text-slate-500 text-xl font-medium max-w-xl mx-auto leading-relaxed">
              Synthesize lecture materials into professional interlinear environments.
            </p>
          </div>
          ...
          <div className="glass-panel rounded-[4rem] p-2 border-white/5 shadow-2xl relative">
            <div className="bg-[#0f172a]/20 rounded-[3.8rem] p-10 md:p-14 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    placeholder="Paste transcripts or unstructured lecture notes..."
                    value={rawInput}
                    ...
                    {!selectedFile ? (
                      <>
                        ...
                        <div className="text-center">
                          <p className="text-white font-black text-xs uppercase tracking-[0.2em]">Select Asset</p>
                          <p className="text-slate-600 text-[9px] uppercase font-bold mt-2">PDF / IMAGE / TXT</p>
                        </div>
                      </>
                    ) : (
                      <div className="flex flex-col items-center gap-6 px-10 text-center animate-in zoom-in-95">
                        ...
                        <div className="max-w-full">
                          ...
                          <button onClick={(e) => { e.stopPropagation(); setSelectedFile(null); }} className="text-red-500 text-[10px] font-black uppercase mt-3 hover:underline tracking-widest">Discard</button>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <button
                ...
                className="group w-full py-8 rounded-[2.5rem] bg-indigo-600 hover:bg-indigo-500 disabled:opacity-20 transition-all shadow-2xl shadow-indigo-600/30 flex items-center justify-center gap-5"
              >
                {isProcessing ? (
                  <><Loader2 className="animate-spin" size={28} /> <span className="text-xl font-black uppercase tracking-[0.3em]">Synthesizing...</span></>
                ) : (
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex overflow-x-hidden selection:bg-indigo-500/30">
      <aside className={`fixed inset-y-0 left-0 z-50 w-80 bg-[#070b14] border-r border-white/5 transform transition-transform duration-700 ease-in-out md:translate-x-0 ${isSidebarOpen ? 'translate-x-0 shadow-3xl' : '-translate-x-full'}`}>
        <div className="p-12 flex flex-col h-full space-y-16">
          ...
          <nav className="flex-1 space-y-5 overflow-y-auto pr-2 custom-scrollbar">
            <p className="text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] px-2 mb-8">Course Directory</p>
      ...
      <main className="flex-1 md:ml-80 min-h-screen relative flex flex-col">
        ...
        <div className="max-w-6xl mx-auto px-10 md:px-24 py-20 md:py-40 space-y-40 flex-1">
          <div className="space-y-12 stagger-in">
            <div className="inline-flex items-center gap-3 bg-indigo-500/10 text-indigo-400 px-6 py-2.5 rounded-full text-[11px] font-black uppercase tracking-[0.4em] border border-indigo-500/20">
            ...
            <div className="relative p-14 glass-panel rounded-[4.5rem] border border-white/5 group">
              ...
              <div className="flex items-center justify-between mb-12">
                <h3 className="text-[11px] font-black text-slate-600 uppercase tracking-[0.5em] flex items-center gap-3"><Info size={16}/> Executive Overview</h3>
        ...
        <footer className="p-24 border-t border-white/5 text-center opacity-10">
          <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.6em]">LectureLens Studio &bull; Neural Intelligence Engine</p>
        </footer>
      </main>
